...
begin
   ...
   WideStr := edit1.Text ; //'é ù è $ €' ;          // $E9 $00 $20 $00 $F9 $00 $20 $00 $E8 $00 $20 $00 $24 $00 $20 $00 $AC $20
   ...
   myTlist.Add (self) ;
   myTlist.Add (self) ;
   ttrace.debug.SendTable('myTlist : SendTable', TEnumerableTObject(myTlist)) ;   // you must cast TList<T> to TEnumerableTObject
   {$endif COMPILER_12_UP}
