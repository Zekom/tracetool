...
{var d=0;var beginLine=c;var hexaRepresentation='';var strRepresentation='';while((byteDumped<count)&&(d<16)&&(c<buffer.length))
{var oneChar=buffer.charAt(c);var oneInt=buffer.charCodeAt(c);var str=intToHex(oneInt,2);hexaRepresentation+=str+' ';if(oneInt==0)
strRepresentation+='.';else
strRepresentation+=oneChar;byteDumped++;d++;c++;}
adr=intToHex(beginLine,6);dumpGroup.add(adr,hexaRepresentation,strRepresentation);}
