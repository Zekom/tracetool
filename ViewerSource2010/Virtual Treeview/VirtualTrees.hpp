...
#pragma option push -b-
enum TCheckImageKind { ckLightCheck, ckDarkCheck, ckLightTick, ckDarkTick, ckFlat, ckXP, ckCustom, ckSystem, ckSystemFlat, ckSystemDefault };
#pragma option pop
...
typedef Set<TVTPaintOption, toHideFocusRect, toHideTreeLinesIfThemed>  TVTPaintOptions;
...
#pragma option push -b-
enum TVTMiscOption { toAcceptOLEDrop, toCheckSupport, toEditable, toFullRepaintOnResize, toGridExtensions, toInitOnSave, toReportMode, toToggleOnDblClick, toWheelPanning, toReadOnly, toVariableNodeHeight, toFullRowDrag, toNodeHeightResize, toNodeHeightDblClickResize };
#pragma option pop

typedef Set<TVTMiscOption, toAcceptOLEDrop, toNodeHeightDblClickResize>  TVTMiscOptions;
...
typedef void __fastcall (__closure *TVTHeaderHeightTrackingEvent)(TVTHeader* Sender, Types::TPoint &P, Classes::TShiftState Shift, bool &Allow);

typedef void __fastcall (__closure *TVTHeaderHeightDblClickResizeEvent)(TVTHeader* Sender, Types::TPoint &P, Classes::TShiftState Shift, bool &Allow);
...
typedef void __fastcall (__closure *TVTBeforeAutoFitColumnEvent)(TVTHeader* Sender, TColumnIndex Column, TSmartAutoFitType &SmartAutoFitType, bool &Allow);
...
typedef void __fastcall (__closure *TVTColumnWidthDblClickResizeEvent)(TVTHeader* Sender, TColumnIndex Column, Classes::TShiftState Shift, const Types::TPoint &P, bool &Allow);
...
typedef void __fastcall (__closure *TVTColumnWidthTrackingEvent)(TVTHeader* Sender, TColumnIndex Column, Classes::TShiftState Shift, Types::TPoint &TrackPoint, const Types::TPoint &P, bool &Allow);
...
typedef void __fastcall (__closure *TVTNodeHeightTrackingEvent)(TBaseVirtualTree* Sender, PVirtualNode Node, TColumnIndex Column, Classes::TShiftState Shift, Types::TPoint &TrackPoint, const Types::TPoint &P, bool &Allow);

typedef void __fastcall (__closure *TVTNodeHeightDblClickResizeEvent)(TBaseVirtualTree* Sender, PVirtualNode Node, TColumnIndex Column, Classes::TShiftState Shift, const Types::TPoint &P, bool &Allow);
...
protected:
	...
	virtual void __fastcall DoHeaderCheckBoxClick(TColumnIndex Column, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	...
	virtual void __fastcall DoHeaderImageClick(TColumnIndex Column, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
...
#define DefaultPaintOptions (Set<TVTPaintOption, toHideFocusRect, toHideTreeLinesIfThemed> () << toShowButtons << toShowDropmark << toShowRoot << toShowTreeLines << toThemeAware << toUseBlendedImages )
...
#define DefaultMiscOptions (Set<TVTMiscOption, toAcceptOLEDrop, toNodeHeightDblClickResize> () << toAcceptOLEDrop << toFullRepaintOnResize << toInitOnSave << toToggleOnDblClick << toWheelPanning )
